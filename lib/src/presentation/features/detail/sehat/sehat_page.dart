...
import 'package:toturo/src/presentation/features/detail/sehat/sehat2_page.dart';
...
void showSehatPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const SehatPage(),
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/sehat.mp4?alt=media&token=03acd1c2-94c2-4dca-8988-453e7299d9e8',
                    ),
                    looping: false,
                  ),
                ),
                      ...
                      Flexible(
                        child: Wrap(
                          children: [
                            ...
                            InkWell(
                              onTap: () => showSehat2Page(context: context),
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Palette.blue,
                                  borderRadius: BorderRadius.circular(12),
