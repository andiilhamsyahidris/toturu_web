...
void showAtletikParalympic({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const AtletikParalympic(),
...
class AtletikParalympic extends StatefulWidget {
  const AtletikParalympic({super.key});

  @override
  State<AtletikParalympic> createState() => _AtletikParalympicState();
}

class _AtletikParalympicState extends State<AtletikParalympic> {
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/atletik_paralympic.mp4?alt=media&token=115c503c-584e-40c1-9ba2-58e9013ee2c1',
                    ),
                    looping: false,
                  ),
                ),
