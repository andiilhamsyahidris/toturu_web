...
import 'package:toturo/src/presentation/features/detail/narkoba/narkoba2_page.dart';
...
void showNarkobaPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const NarkobaPage(),
...
class NarkobaPage extends StatelessWidget {
  const NarkobaPage({super.key});
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/narkoba.mp4?alt=media&token=84365e6c-ae75-49c9-8ef9-f768d152cd0d',
                    ),
                    looping: false,
                  ),
                ),
                      ...
                      Flexible(
                        child: Wrap(
                          children: [
                            ...
                            InkWell(
                              onTap: () => showNarkoba2Page(context: context),
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Palette.blue,
                                  borderRadius: BorderRadius.circular(12),
