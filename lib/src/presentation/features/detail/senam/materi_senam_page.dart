...
void showMateriSenamPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const MateriSenamPage(),
...
class MateriSenamPage extends StatelessWidget {
  const MateriSenamPage({super.key});
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/senam_materi.mp4?alt=media&token=fc249818-a963-4d72-b6b2-eb1e84b049da',
                    ),
                    looping: false,
                  ),
                ),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Wrap(
                          children: [
                            InkWell(
                              onTap: () => showSenamPage(context: context),
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Palette.blue,
