...
void showPukulanDropshotPageMobile({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const PukulanDropshotPageMobile(),
...
class PukulanDropshotPageMobile extends StatefulWidget {
  const PukulanDropshotPageMobile({super.key});

  @override
  State<PukulanDropshotPageMobile> createState() =>
      _PukulanDropshotPageMobileState();
}

class _PukulanDropshotPageMobileState extends State<PukulanDropshotPageMobile> {
