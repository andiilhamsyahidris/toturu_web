...
void showPukulanLobPageMobile({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const PukulanLobPageMobile(),
...
class PukulanLobPageMobile extends StatefulWidget {
  const PukulanLobPageMobile({super.key});

  @override
  State<PukulanLobPageMobile> createState() => _PukulanLobPageMobileState();
}

class _PukulanLobPageMobileState extends State<PukulanLobPageMobile> {
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/bulutangkis_lob.mp4?alt=media&token=dfbb02a0-702b-4e8c-9a5b-80632c80c1cc',
                    ),
                    looping: false,
                  ),
                ),
