...
import 'package:toturo/src/presentation/features/detail/badminton/mobile/pukulan_smash_page.dart';
...
void showSaranaBulutangkisPageMobile({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const SaranaBulutangkisPageMobile(),
...
class SaranaBulutangkisPageMobile extends StatefulWidget {
  const SaranaBulutangkisPageMobile({super.key});

  @override
  State<SaranaBulutangkisPageMobile> createState() =>
      _SaranaBulutangkisPageMobileState();
}

class _SaranaBulutangkisPageMobileState
    extends State<SaranaBulutangkisPageMobile> {
              ...
              children: [
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/bulutangkis_sarana.mp4?alt=media&token=61e11050-a727-485d-867f-582c24476538',
                    ),
                    looping: false,
                  ),
                ),
                    ...
                    children: [
                      ...
                      Wrap(
                        children: [
                          ...
                          InkWell(
                            onTap: () =>
                                showPukulanSmashPageMobile(context: context),
                            child: Container(
                              decoration: BoxDecoration(
                                color: Palette.blue,
                                borderRadius: BorderRadius.circular(12),
                ...
                SizedBox(
                  ...
                  child: SfPdfViewer.asset(
                    'assets/document/bulutangkis_sarana.pdf',
                    pageSpacing: 2,
