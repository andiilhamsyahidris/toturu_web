...
void showPukulanServisPageMobile({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const PukulanServisPageMobile(),
...
class PukulanServisPageMobile extends StatefulWidget {
  const PukulanServisPageMobile({super.key});

  @override
  State<PukulanServisPageMobile> createState() =>
      _PukulanServisPageMobileState();
}

class _PukulanServisPageMobileState extends State<PukulanServisPageMobile> {
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/bulutangkis_servis.mp4?alt=media&token=5d0fc12a-0284-4b51-b402-42d204ac313b',
                    ),
                    looping: false,
                  ),
                ),
