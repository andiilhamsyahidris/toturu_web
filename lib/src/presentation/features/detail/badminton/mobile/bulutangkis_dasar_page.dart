...
void showBulutangkisDasarPageMobile({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const BulutangkisDasarPageMobile(),
...
class BulutangkisDasarPageMobile extends StatefulWidget {
  const BulutangkisDasarPageMobile({super.key});

  @override
  State<BulutangkisDasarPageMobile> createState() =>
      _BulutangkisDasarPageMobileState();
}

class _BulutangkisDasarPageMobileState
    extends State<BulutangkisDasarPageMobile> {
                ...
                Container(
                  ...
                  child: Videos(
                    videoPlayerController: VideoPlayerController.network(
                      'https://firebasestorage.googleapis.com/v0/b/toturu-a6162.appspot.com/o/bulutangkis_dasar.mp4?alt=media&token=740e1812-9017-4df3-97cd-bedd0227d693',
                    ),
                    looping: false,
                  ),
                ),
