...
void showPukulanServisPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const PukulanServisPage(),
...
class PukulanServisPage extends StatefulWidget {
  const PukulanServisPage({super.key});

  @override
  State<PukulanServisPage> createState() => _PukulanServisPageState();
}

class _PukulanServisPageState extends State<PukulanServisPage> {
