...
void showSaranaBulutangkisPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const SaranaBulutangkisPage(),
...
class SaranaBulutangkisPage extends StatefulWidget {
  const SaranaBulutangkisPage({super.key});

  @override
  State<SaranaBulutangkisPage> createState() => _SaranaBulutangkisPageState();
}

class _SaranaBulutangkisPageState extends State<SaranaBulutangkisPage> {
                    ...
                    children: [
                      ...
                      Wrap(
                        children: [
                          ...
                          InkWell(
                            onTap: () =>
                                showPukulanDropshotPage(context: context),
                            child: Container(
                              decoration: BoxDecoration(
                                color: Palette.blue,
                                borderRadius: BorderRadius.circular(12),
