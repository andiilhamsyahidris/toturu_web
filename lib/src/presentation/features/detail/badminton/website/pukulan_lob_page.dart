...
void showPukulanLobPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const PukulanLobPage(),
...
class PukulanLobPage extends StatefulWidget {
  const PukulanLobPage({super.key});

  @override
  State<PukulanLobPage> createState() => _PukulanLobPageState();
}

class _PukulanLobPageState extends State<PukulanLobPage> {
