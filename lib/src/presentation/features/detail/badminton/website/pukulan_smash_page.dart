...
void showPukulanSmashPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const PukulanSmashPage(),
...
class PukulanSmashPage extends StatefulWidget {
  const PukulanSmashPage({super.key});

  @override
  State<PukulanSmashPage> createState() => _PukulanSmashPageState();
}

class _PukulanSmashPageState extends State<PukulanSmashPage> {
