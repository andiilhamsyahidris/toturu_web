...
void showBulutangkisDasarPage({required BuildContext context}) {
  Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => const BulutangkisDasaraPage(),
...
class BulutangkisDasaraPage extends StatefulWidget {
  const BulutangkisDasaraPage({super.key});

  @override
  State<BulutangkisDasaraPage> createState() => _BulutangkisDasaraPageState();
}

class _BulutangkisDasaraPageState extends State<BulutangkisDasaraPage> {
